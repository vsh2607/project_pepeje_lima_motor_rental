...
@section('title', 'Edit Data Administrasi Motor')
...
@section('content_header')
    <h1>Edit Data Administrasi Motor</h1>
@stop
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="id_master_motor" id="id_master_motor" class="form-control" required>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control my-input" id="credit" name="credit" required
                                    placeholder="MASUKKAN TOTAL PENGELUARAN" value="Rp. {{ number_format($data->credit, 0, ',', '.') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input value="{{ number_format($data->logKm->total_km, 0, ',', '.') }}" required type="text" class="my-input form-control" id="total_km" name="total_km" placeholder="MASUKKAN KM MOTOR SAAT INI">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="remark" id="remark" class="form-control my-input" cols="30" rows="5" required {{ $data->remark == 'BELI AWAL MOTOR' ? 'readonly' : '' }}>{{ $data->remark }}</textarea>
                            </div>
                        </div>
                    </div>
