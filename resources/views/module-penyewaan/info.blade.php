            ...
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-footer" style="text-align: center">
                        @if ($data->status == 1)
                            ...
                            <span class='badge badge-success'>{{ $total_hari_sewa }} hari</span>
                            <span class='badge badge-success'>{{ $total_biaya_sewa }}</span>
                        @endif
                ...
                @if ($data->status == 1)
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img src="{{ asset('jaminan_images') . '/' . $data->jaminan_img }}" alt="jaminan img"
                                width="200px">
                        </div>
                    </div>
                @endif
            ...
            <div class="col-9">
                <div class="card">
                    <div class="card-header">
                        @if ($data->status == 1)
                            <a href='{{ url('module-manajemen/module-sewa/' . $data->id . '/edit') }}'
                    ...
                    <div class="card-body">
                        ...
                        @if ($data->status == 0)
                            <div class="form-group">
                                <label class='required' for="tanggal_pengembalian">Tanggal Pengembalian</label>
                                <input required readonly type="text" name="tanggal_pengembalian"
                                    id="tanggal_pengembalian" class="form-control my-input"
